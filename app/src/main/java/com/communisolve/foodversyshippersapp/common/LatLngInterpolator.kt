...
interface LatLngInterpolator {
    ...
    class LinearFixed : LatLngInterpolator {
        override fun interpolate(fraction: Float, a: LatLng, b: LatLng): LatLng {
            val lat = (b.latitude - a.latitude) * fraction + b.latitude
    ...
    class Spherical:LatLngInterpolator{
        override fun interpolate(fraction: Float, from: LatLng, to: LatLng): LatLng {
            ...
            val a = Math.sin((1-fraction)*angle)/2
            ...
            val z=a * Math.sin(fromLat) + b*Math.sin(fromLat)
        ...
        private fun computeAngleBetween(
            ...
            return 2*Math.asin(Math.sqrt(Math.sqrt(Math.pow(Math.sin(dLat/2),2.0)+
